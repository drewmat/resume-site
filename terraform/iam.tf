...
resource "aws_iam_user_policy" "github-actions-s3" {
...
resource "aws_iam_user_policy" "github-actions-cloudfront" {
...
resource "aws_iam_user_policy" "github-actions-dns" {
...
data "aws_iam_policy_document" "github-actions-iam" {
  statement {
    ...
    resources = [
      "arn:aws:iam::*:user/github-actions-default",
      "arn:aws:iam::*:user/github-actions-dev",
      "arn:aws:iam::*:user/github-actions-prod",
    ]
  }
}

resource "aws_iam_user_policy" "github-actions-iam" {
